...
#define MODE_KEY1_READ  (MODE_KEY_PORT->IDR & MODE_KEY1_PIN_R)
#define MODE_KEY2_READ  (MODE_KEY_PORT->IDR & MODE_KEY2_PIN_R)
#define MODE_KEY3_READ  (MODE_KEY_PORT->IDR & MODE_KEY3_PIN_R)
#define MODE_KEY4_READ  (MODE_KEY_PORT->IDR & MODE_KEY4_PIN_R)
